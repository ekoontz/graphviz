...
#line 39 "../../../cmd/lefty/dot2l/dotparse.y"
{
    long i;
    char *s;
    void *o;
...
{
       0,    54,    54,    53,    57,    60,    63,    65,    67,    69,
      73,    74,    77,    78,    81,    82,    85,    86,    87,    88,
      91,    91,    95,    99,   104,   106,   103,   110,   112,   109,
     117,   120,   119,   121,   124,   123,   127,   128,   129,   130,
     131,   134,   138,   147,   154,   153,   157,   161,   163,   165,
     169,   172,   173,   176,   179,   180,   183,   187,   188,   191,
     193,   193,   195,   199
};
#endif
...
#line 54 "../../../cmd/lefty/dot2l/dotparse.y"
    { D2Lbegin ((yyvsp[(2) - (2)].s)); free ((yyvsp[(2) - (2)].s)); }
    break;
...
#line 58 "../../../cmd/lefty/dot2l/dotparse.y"
  ...
  case 5:
#line 60 "../../../cmd/lefty/dot2l/dotparse.y"
    { D2Labort (); }
    break;
...
#line 68 "../../../cmd/lefty/dot2l/dotparse.y"
  ...
  case 9:
#line 70 "../../../cmd/lefty/dot2l/dotparse.y"
    { gtype = "strict digraph"; etype = "->"; }
    break;

  case 19:
#line 88 "../../../cmd/lefty/dot2l/dotparse.y"
    {}
    break;

  case 20:
#line 91 "../../../cmd/lefty/dot2l/dotparse.y"
    { attrclass = NODE; portstr[0] = '\000'; }
    break;

  case 21:
#line 92 "../../../cmd/lefty/dot2l/dotparse.y"
    { attrclass = GRAPH; }
    break;

  case 22:
#line 96 "../../../cmd/lefty/dot2l/dotparse.y"
    { (yyval.o) = (yyvsp[(1) - (2)].o); }
    break;

  case 23:
#line 100 "../../../cmd/lefty/dot2l/dotparse.y"
    { (yyval.o) = D2Linsertnode ((yyvsp[(1) - (1)].s)); free ((yyvsp[(1) - (1)].s)); }
    break;

  case 24:
#line 104 "../../../cmd/lefty/dot2l/dotparse.y"
    { D2Lbeginedge (NODE, (yyvsp[(1) - (1)].o), portstr); portstr[0] = '\000'; }
    break;
...
#line 110 "../../../cmd/lefty/dot2l/dotparse.y"
    { D2Lbeginedge (GRAPH, (yyvsp[(1) - (1)].o), ""); }
    break;
...
#line 112 "../../../cmd/lefty/dot2l/dotparse.y"
  ...
  case 29:
#line 114 "../../../cmd/lefty/dot2l/dotparse.y"
    { D2Lendedge (); attrclass = GRAPH; }
    break;

  case 30:
#line 118 "../../../cmd/lefty/dot2l/dotparse.y"
    { D2Lmidedge (NODE, (yyvsp[(2) - (2)].o), portstr); portstr[0] = '\000'; }
    break;
...
#line 122 "../../../cmd/lefty/dot2l/dotparse.y"
    { D2Lmidedge (GRAPH, (yyvsp[(2) - (2)].o), ""); portstr[0] = '\000'; }
    break;

  case 34:
#line 124 "../../../cmd/lefty/dot2l/dotparse.y"
    { D2Lmidedge (GRAPH, (yyvsp[(2) - (2)].o), ""); portstr[0] = '\000'; }
    break;

  case 41:
#line 135 "../../../cmd/lefty/dot2l/dotparse.y"
    {
        strcat (portstr, (yyvsp[(2) - (2)].s)); free ((yyvsp[(2) - (2)].s));
    }
    break;

  case 42:
#line 139 "../../../cmd/lefty/dot2l/dotparse.y"
    {
        strcat (portstr, "("); strcat (portstr, (yyvsp[(3) - (6)].s));
        strcat (portstr, ","); strcat (portstr, (yyvsp[(5) - (6)].s));
        strcat (portstr, ")");
        free ((yyvsp[(3) - (6)].s)), free ((yyvsp[(5) - (6)].s));
    }
    break;

  case 43:
#line 148 "../../../cmd/lefty/dot2l/dotparse.y"
    {
        strcat (portstr, "@"); strcat (portstr, (yyvsp[(2) - (2)].s)); free ((yyvsp[(2) - (2)].s));
    }
    break;
...
#line 156 "../../../cmd/lefty/dot2l/dotparse.y"
  ...
  case 46:
#line 158 "../../../cmd/lefty/dot2l/dotparse.y"
    { attrclass = GRAPH; }
    break;
...
#line 164 "../../../cmd/lefty/dot2l/dotparse.y"
  ...
  case 49:
#line 166 "../../../cmd/lefty/dot2l/dotparse.y"
    { attrclass = EDGE; }
    break;

  case 56:
#line 184 "../../../cmd/lefty/dot2l/dotparse.y"
    { D2Lsetattr ((yyvsp[(1) - (3)].s), (yyvsp[(3) - (3)].s)); free ((yyvsp[(1) - (3)].s)); free ((yyvsp[(3) - (3)].s)); }
    break;
...
#line 192 "../../../cmd/lefty/dot2l/dotparse.y"
  ...
  case 60:
#line 193 "../../../cmd/lefty/dot2l/dotparse.y"
    { D2Lpushgraph (NULL); }
    break;
...
#line 194 "../../../cmd/lefty/dot2l/dotparse.y"
  ...
  case 62:
#line 196 "../../../cmd/lefty/dot2l/dotparse.y"
    { (yyval.o) = D2Lpopgraph (); }
    break;

  case 63:
#line 200 "../../../cmd/lefty/dot2l/dotparse.y"
    { D2Lpushgraph ((yyvsp[(2) - (2)].s)); free ((yyvsp[(2) - (2)].s)); }
    break;
