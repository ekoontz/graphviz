...
CLEAN :
	...
	-@erase "$(INTDIR)\gd_gif_in.obj"
	-@erase "$(INTDIR)\gd_gif_out.obj"
	...
	-@erase "$(INTDIR)\gd_security.obj"
	-@erase "$(INTDIR)\gd_ss.obj"
	-@erase "$(INTDIR)\gd_topal.obj"
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /I "." /I "..\.." /I "..\..\third-party\include" /I "..\..\third-party\include\freetype2" /D "NONDLL" /D "WIN32" /D "NDEBUG" /D "_MBCS" /D "_LIB" /D "MSWIN32" /D "HAVE_CONFIG_H" /Fp"$(INTDIR)\gd.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
BSC32=bscmake.exe
...
LIB32_OBJS= \
	...
	"$(INTDIR)\gd_gd.obj" \
	"$(INTDIR)\gd_gd2.obj" \
	"$(INTDIR)\gd_gif_in.obj" \
	"$(INTDIR)\gd_gif_out.obj" \
	"$(INTDIR)\gd_io.obj" \
	"$(INTDIR)\gd_io_dp.obj" \
...
$(DS_POSTBUILD_DEP) : "$(OUTDIR)\gd.lib"
   copy .\Release\gd.lib ..\lib\Release
...
CLEAN :
	...
	-@erase "$(INTDIR)\gd_gif_in.obj"
	-@erase "$(INTDIR)\gd_gif_in.sbr"
	-@erase "$(INTDIR)\gd_gif_out.obj"
	-@erase "$(INTDIR)\gd_gif_out.sbr"
	-@erase "$(INTDIR)\gd_io.obj"
	...
	-@erase "$(INTDIR)\gd_security.obj"
	-@erase "$(INTDIR)\gd_security.sbr"
	-@erase "$(INTDIR)\gd_ss.obj"
	-@erase "$(INTDIR)\gd_ss.sbr"
	-@erase "$(INTDIR)\gd_topal.obj"
	-@erase "$(INTDIR)\gd_topal.sbr"
	-@erase "$(INTDIR)\gd_wbmp.obj"
...
CPP_PROJ=/nologo /MLd /W3 /Gm /Gi /GX /ZI /Od /I "." /I "..\.." /I "..\..\third-party\include" /I "..\..\third-party\include\freetype2" /D "WIN32" /D "_DEBUG" /D "_MBCS" /D "_LIB" /D "MSWIN32" /D "HAVE_CONFIG_H" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\gd.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\gd.bsc" 
BSC32_SBRS= \
	"$(INTDIR)\gd.sbr" \
	"$(INTDIR)\gd_gd.sbr" \
	"$(INTDIR)\gd_gd2.sbr" \
	"$(INTDIR)\gd_gif_in.sbr" \
	"$(INTDIR)\gd_gif_out.sbr" \
	"$(INTDIR)\gd_io.sbr" \
	"$(INTDIR)\gd_io_dp.sbr" \
...
CPP_SWITCHES=/nologo /ML /W3 /GX /O2 /I "." /I "..\.." /I "..\..\third-party\include" /I "..\..\third-party\include\freetype2" /I "..\..\third-party\freetype2" /D "NONDLL" /D "WIN32" /D "NDEBUG" /D "_MBCS" /D "_LIB" /D "MSWIN32" /D "HAVE_CONFIG_H" /Fp"$(INTDIR)\gd.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
CPP_SWITCHES=/nologo /MLd /W3 /Gm /Gi /GX /ZI /Od /I "." /I "..\.." /I "..\..\third-party\include" /I "..\..\third-party\include\freetype2" /I "..\..\third-party\freetype2" /D "WIN32" /D "_DEBUG" /D "_MBCS" /D "_LIB" /D "MSWIN32" /D "HAVE_CONFIG_H" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\gd.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
...
"$(INTDIR)\gd_gif_in.obj" : $(SOURCE) "$(INTDIR)"


!ELSEIF  "$(CFG)" == "gd - Win32 Debug"


"$(INTDIR)\gd_gif_in.obj"	"$(INTDIR)\gd_gif_in.sbr" : $(SOURCE) "$(INTDIR)"
...
"$(INTDIR)\gd_gif_out.obj" : $(SOURCE) "$(INTDIR)"


!ELSEIF  "$(CFG)" == "gd - Win32 Debug"


"$(INTDIR)\gd_gif_out.obj"	"$(INTDIR)\gd_gif_out.sbr" : $(SOURCE) "$(INTDIR)"
...
CPP_SWITCHES=/nologo /ML /W3 /GX /O2 /I "." /I "..\.." /I "..\..\third-party\include" /I "..\..\third-party\include\freetype2" /I "..\..\third-party\freetype2" /D "WIN32" /D "NDEBUG" /D "_MBCS" /D "_LIB" /D "MSWIN32" /D "HAVE_CONFIG_H" /Fp"$(INTDIR)\gd.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
"$(INTDIR)\gd_security.obj" : $(SOURCE) "$(INTDIR)"


!ELSEIF  "$(CFG)" == "gd - Win32 Debug"


"$(INTDIR)\gd_security.obj"	"$(INTDIR)\gd_security.sbr" : $(SOURCE) "$(INTDIR)"
...
"$(INTDIR)\gd_topal.obj" : $(SOURCE) "$(INTDIR)"


!ELSEIF  "$(CFG)" == "gd - Win32 Debug"


"$(INTDIR)\gd_topal.obj"	"$(INTDIR)\gd_topal.sbr" : $(SOURCE) "$(INTDIR)"
...
CPP_SWITCHES=/nologo /ML /W3 /GX /O2 /I "." /I "..\.." /I "..\..\third-party\include" /I "..\..\third-party\include\freetype2" /I "..\third-party\include\freetype2" /D "WIN32" /D "NDEBUG" /D "_MBCS" /D "_LIB" /D "MSWIN32" /D "HAVE_CONFIG_H" /Fp"$(INTDIR)\gd.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
CPP_SWITCHES=/nologo /MLd /W3 /Gm /Gi /GX /ZI /Od /I "." /I "..\.." /I "..\..\third-party\include" /I "..\..\third-party\include\freetype2" /I "..\third-party\include\freetype2" /D "WIN32" /D "_DEBUG" /D "_MBCS" /D "_LIB" /D "MSWIN32" /D "HAVE_CONFIG_H" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\gd.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
...
"$(INTDIR)\gdfx.obj" : $(SOURCE) "$(INTDIR)"


!ELSEIF  "$(CFG)" == "gd - Win32 Debug"


"$(INTDIR)\gdfx.obj"	"$(INTDIR)\gdfx.sbr" : $(SOURCE) "$(INTDIR)"
