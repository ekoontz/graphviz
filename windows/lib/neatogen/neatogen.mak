...
CLEAN :
	...
	-@erase "$(INTDIR)\constrained_majorization_ipsep.obj"
	...
	-@erase "$(INTDIR)\mosek_quad_solve.obj"
	-@erase "$(INTDIR)\neatoinit.obj"
	-@erase "$(INTDIR)\neatosplines.obj"
	...
	-@erase "$(INTDIR)\quad_prog_vpsc.obj"
...
LIB32_OBJS= \
	...
	"$(INTDIR)\constrained_majorization_ipsep.obj" \
...
SOURCE=.\constrained_majorization_ipsep.c

"$(INTDIR)\constrained_majorization_ipsep.obj" : $(SOURCE) "$(INTDIR)"
...
SOURCE=.\mosek_quad_solve.c

"$(INTDIR)\mosek_quad_solve.obj" : $(SOURCE) "$(INTDIR)"
...
SOURCE=.\quad_prog_vpsc.c

"$(INTDIR)\quad_prog_vpsc.obj" : $(SOURCE) "$(INTDIR)"
